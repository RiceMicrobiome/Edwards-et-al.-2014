...
gh.tax <- read.table("~/RICE/Publication/Data/GreenhouseExp/gh_tax.txt", header = T, row.names = 1)
...
arb.e.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Endosphere" & Site == "Arbuckle")$OTU
arb.rp.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Rhizoplane" & Site == "Arbuckle")$OTU
arb.rs.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Rhizosphere" & Site == "Arbuckle")$OTU
dav.e.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Endosphere" & Site == "Davis")$OTU
dav.rp.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Rhizoplane" & Site == "Davis")$OTU
dav.rs.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Rhizosphere" & Site == "Davis")$OTU
sac.e.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Endosphere" & Site == "Sacramento")$OTU
sac.rp.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Rhizoplane" & Site == "Sacramento")$OTU
sac.rs.down <- subset(gh.comp.site.glm, color == "bs" & Comp == "Rhizosphere" & Site == "Sacramento")$OTU
...
venn.diagram(list( Endosphere = arb.e.up, Rhizoplane = arb.rp.up, Rhizosphere = arb.rs.up), 
             fill = c("#377EBA", "#4DAF4A", "#984EA3" ), cex = 3,
             filename = "~/RMB//Publication/GHFigures/DA/Site_Comp_Venn/arbuckle_comp_0.01.tiff")
venn.diagram(list( Endosphere = sac.e.up, Rhizoplane = sac.rp.up, Rhizosphere = sac.rs.up), 
             fill = c("#377EBA", "#4DAF4A", "#984EA3" ), cex = 3,
             filename = "~/RMB//Publication/GHFigures/DA/Site_Comp_Venn/sacramento_comp_0.01.tiff")
venn.diagram(list( Endosphere = dav.e.up, Rhizoplane = dav.rp.up, Rhizosphere = dav.rs.up), 
             fill = c("#377EBA", "#4DAF4A", "#984EA3" ), cex = 3,
             filename = "~/RMB//Publication/GHFigures/DA/Site_Comp_Venn/davis_comp_0.01.tiff")

venn.diagram(list( Endosphere = arb.e.down, Rhizoplane = arb.rp.down, Rhizosphere = arb.rs.down), 
             fill = c("#377EBA", "#4DAF4A", "#984EA3" ), cex = 3,
             filename = "~/RMB//Publication/GHFigures/DA/Site_Comp_Venn/arbuckle_comp_down.tiff")
venn.diagram(list( Endosphere = sac.e.down, Rhizoplane = sac.rp.down, Rhizosphere = sac.rs.down), 
             fill = c("#377EBA", "#4DAF4A", "#984EA3" ), cex = 3,
             filename = "~/RMB//Publication/GHFigures/DA/Site_Comp_Venn/sacramento_comp_down.tiff")
venn.diagram(list( Endosphere = dav.e.down, Rhizoplane = dav.rp.down, Rhizosphere = dav.rs.down), 
             fill = c("#377EBA", "#4DAF4A", "#984EA3" ), cex = 3,
             filename = "~/RMB//Publication/GHFigures/DA/Site_Comp_Venn/davis_comp_down.tiff")
